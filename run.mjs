/**
 * Benchmark: 同一扩展在 addfox / wxt / plasmo 下的 dev 就绪时间、HMR 时间、打包时间、打包体积。
 * 使用方式: 在包含 benchmark 目录的仓库根目录执行 `node benchmark/run.mjs`
...
const FRAMEWORKS = [
  {
    name: "addfox",
    cwd: join(BENCH_DIR, "addfox"),
    devCommand: "pnpm run dev",
    buildCommand: "pnpm run build",
    buildOutDir: join(BENCH_DIR, "addfox", ".addfox", "extension", "extension-chromium"),
    devReadyPattern: /built in|ready|\[Addfox\]/i,
